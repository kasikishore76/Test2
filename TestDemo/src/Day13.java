...
public class Day13 {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		WebElement radmale=driver.findElement(By.xpath("/html/body/form/div[2]/div[15]/table/tbody/tr[1]/td/label"));	
		...
		driver.findElement(By.xpath("/html/body/form/div[2]/div[17]/table/tbody/tr/td[1]")).click();
